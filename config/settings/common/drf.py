...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        # "apps.auth.auth_classes.CustomTokenAuthentication",
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Api of Project Tracker Blog",
    ...
    "SERVE_PERMISSIONS": ("libs.permissions.HasAccessToDebugTools",),
    "SWAGGER_UI_SETTINGS": {
        "deepLinking": True,
        "docExpansion": "none",
    },
    # https://github.com/tfranzel/drf-spectacular/issues/1186
